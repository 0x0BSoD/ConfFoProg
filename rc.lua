...
beautiful.init(pConfig .. "themes/cyclone/theme.lua")
...
modkey     = "Mod4"
font       = "Inconsolata 11"
kbdd_next = "ru.gentoo.KbddService /ru/gentoo/KbddService ru.gentoo.kbdd.next_layout"
--========================================
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "main", "internet", "fm", "ssh", "other" }, s, layouts[1])
end
-- }}}
--========================================
...
vicious.register(fswidget, vicious.widgets.fs,'<span background="#D0785D" font="Inconsolata 11"> <span font="Inconsolata 11" color="#EEEEEE">${/ used_gb}/${/ avail_gb} GB </span></span>', 800)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "u", function() awful.util.spawn("amixer set Master 5%+", false) end),
    awful.key({ modkey,           }, "d", function() awful.util.spawn("amixer set Master 5%-", false) end),
    awful.key({ modkey,           }, "m", function() awful.util.spawn("amixer set Master toggle", false) end),
    awful.key({ modkey,  "Alt"    }, "space", function() os.execute("ru.gentoo.KbddService /ru/gentoo/KbddService ru.gentoo.kbdd.next_layout") end),
    awful.key({ modkey,           }, "j",
        function ()
            awful.client.focus.byidx( 1)
            if client.focus then client.focus:raise() end
